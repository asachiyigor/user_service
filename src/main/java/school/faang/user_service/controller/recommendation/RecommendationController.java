...
public class RecommendationController {
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved recommendation", content = {
          @Content(mediaType = "application/json")}),
      @ApiResponse(responseCode = "404", description = "Recommendation with provided id is not found", content = {
          @Content(mediaType = "application/json")}),
  })
  @GetMapping("/{id}")
  @ResponseStatus(HttpStatus.OK)
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved list for provided authorId", content = {
          @Content(mediaType = "application/json")})
  })
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Recommendation created successfully", content = {
          @Content(mediaType = "application/json")}),
      @ApiResponse(responseCode = "400", description = "Bad Request for create recomendation", content = {
          @Content(mediaType = "application/json")}),
  })
  @PostMapping
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Recommendation updated successfully", content = {
          @Content(mediaType = "application/json")}),
      @ApiResponse(responseCode = "400", description = "Bad Request for update recommendation", content = {
          @Content(mediaType = "application/json")}),
      @ApiResponse(responseCode = "404", description = "Recommendation Id was not found", content = {
          @Content(mediaType = "application/json")}),
  })
  @PutMapping("/{id}")
  @ResponseStatus(HttpStatus.OK)
  ...
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Recommendation deleted successfully", content = {
          @Content(mediaType = "application/json")}),
      @ApiResponse(responseCode = "404", description = "Recommendation Id was not found", content = {
          @Content(mediaType = "application/json")}),
  })
